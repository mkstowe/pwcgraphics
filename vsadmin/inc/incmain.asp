...
if getpost("posted")="1" then
	...
	sSQL = sSQL & ",googleTagID='" & escape_string(getpost("googletagid")) & "'"
...
%></select></td>
	...
	<h3 class="round_top half_top"><button class="mainbutton" id="mainbutton9" type="button" onclick="showtablerows(9,'<%=jsescape("Google reCaptcha + Analytics 4")%>')"><%="Google reCaptcha + Analytics 4"%> <div style="float:right">&#9660;</div></button></h3>
	<table class="admin-table-b keeptable mainsettings" id="maintable9">
		<tr><th colspan="2">Google keys for reCAPTCHA and Global Site Tag for Google Analytics 4.</th></tr>
		<tr class="maintablehidden">
			<td><strong><%="Global Site Tag"%>: </strong></td>
			<td><input type="text" name="googletagid" size="30" value="<%=htmlspecials(rs("googleTagID"))%>" /></td>
		</tr>
		<tr><td colspan="2">Automatically integrate Google's reCAPTCHA security system on your website.</td></tr>
		<tr class="maintablehidden">
