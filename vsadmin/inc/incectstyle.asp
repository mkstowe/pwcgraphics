...
if googletagid<>"" then
response.write "<script async src=""https://www.googletagmanager.com/gtag/js?id=" & googletagid & """></script>" & _
"<script>" & _
"	window.dataLayer = window.dataLayer || [];" & _
"	function gtag(){dataLayer.push(arguments);}" & _
"	gtag('js', new Date());" & _
"	gtag('config', '" & googletagid & "');" & _
"</script>" & vbLf
end if
