...
<%	end if %>
				<div class="ectdivcontainer">
				  ...
				  <div class="ectdivright"><%
					if (getpost("act")="editaffil" AND trim(SESSION("affilid"))<>"") then
						...
						%><input type="text" class="ecttextinput" name="affilid" size="30" value="<%=htmlspecials(affilid)%>" />
				...
				<div class="ectdivcontainer">
				  ...
				  <div class="ectdivright"><input type="password" class="ecttextinput" name="affilpw" size="20" value="" autocomplete="off" /></div>
				</div>
				<div class="ectdivcontainer">
				  <div class="ectdivleft"><%=redasterix&xxName%></div>
				  <div class="ectdivright"><input type="text" class="ecttextinput" name="name" size="20" value="<%=htmlspecials(affilName)%>" /></div>
				</div>
				<div class="ectdivcontainer">
				  <div class="ectdivleft"><%=redasterix&xxEmail%></div>
				  <div class="ectdivright"><input type="text" class="ecttextinput" name="email" size="25" value="<%=htmlspecials(affilEmail)%>" /></div>
				</div>
				<div class="ectdivcontainer">
				  <div class="ectdivleft"><%=redasterix&xxAddress%></div>
				  <div class="ectdivright"><input type="text" class="ecttextinput" name="address" size="20" value="<%=htmlspecials(affilAddress)%>" /></div>
				</div>
				<div class="ectdivcontainer">
				  <div class="ectdivleft"><%=redasterix&xxCity%></div>
				  <div class="ectdivright"><input type="text" class="ecttextinput" name="city" size="20" value="<%=htmlspecials(affilCity)%>" /></div>
				</div>
				<div class="ectdivcontainer">
				  <div class="ectdivleft"><%=redasterix&xxAllSta%></div>
				  <div class="ectdivright"><input type="text" class="ecttextinput" name="state" size="20" value="<%=htmlspecials(affilState)%>" /></div>
				</div>
				<div class="ectdivcontainer">
...
%></select>
				...
				<div class="ectdivcontainer">
				  ...
				  <div class="ectdivright"><input type="text" class="ecttextinput" name="zip" size="10" value="<%=htmlspecials(affilZip)%>" /></div>
				</div>
				<div class="ectdivcontainer">
				  <div class="ectdivleft"><%=xxInfMe%></div>
				  <div class="ectdivright"><input type="checkbox" class="ectcheckbox" name="inform" value="ON" <% if affilInform then print "checked"%> /></div>
				</div>
