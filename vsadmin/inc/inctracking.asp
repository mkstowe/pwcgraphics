...
%>
		  ...
		  <div class="ectdiv2column"><input type="checkbox" class="ectcheckbox" name="agreeconds" value="ON" <%if getpost("agreeconds")="ON" then print "checked"%> /> By selecting this box and the "Track Package" button, I agree to these <a class="ectlink" href="javascript:viewlicense();">Terms and Conditions</a>.</div>
