...
<% isprinter=(request.querystring("printer")="true" OR request.querystring("invoice")="true") %>
<!doctype html>
<head>
...
<%	if NOT isprinter then response.write "<div id=""main"">" else response.write "<div id=""mainprint""" & IIfVr(righttoleft=TRUE," style=""direction:rtl;""", "") & ">"
