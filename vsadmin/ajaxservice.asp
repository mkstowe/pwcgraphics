	...
	if is_numeric(ordID) AND getpayprovdetails(31,data1,data2,data3,demomode,ppmethod) then
		...
		if NOT rs.EOF then
			...
			post="{""session"":{""returnUrl"":{""url"":""" & storeurlssl & "thanks.asp?pprov=31&ordid=" & ordID & """}," & _
				...
				"},""transaction"":{""merchantReference"":""" & ordID & """,""money"":{""amount"":{""fixed"":" & grandtotal & "},""currency"":""" & countryCurrency & """},""deferred"":" & IIfVr(ppmethod=1,"true","false") & "}," & _
...
elseif getget("action")="termsandconditions" then
	print "<div class=""termsandconds"">"
		...
		print "<div class=""termsandcondsbutton"" style=""text-align:center;padding:20px"">"
			print "<input type=""button"" class=""ectbutton no-print"" value=""" & htmlspecials(xxTncYes) & """ style=""margin:20px"" onclick=""document.getElementById('ecttnccheckbox').checked=true;closetandc()"" />"
			print "<input type=""button"" class=""ectbutton no-print"" value=""" & htmlspecials(xxTncPrn) & """ style=""margin:20px"" onclick=""doprintterms()"" />"
			print "<input type=""button"" class=""ectbutton no-print"" value=""" & htmlspecials(xxTncNo) & """ style=""margin:20px"" onclick=""document.getElementById('ecttnccheckbox').checked=false;closetandc()"" />"
		print "</div>"
	print "</div>"
